    ...
    class Program {
        static void Main(string[] args) {
          ...
          pizzas = new List<Pizza>{
            new Pizza("S", "thin", new List<string>{"mushrooms", "green peppers", "onions", "pepperoni", "black olives", "sausage"}, 10.00),
            new Pizza("M", "thin", new List<string>{"mushrooms", "green peppers", "onions", "pepperoni", "black olives", "sausage"}, 15.00),
            new Pizza("L", "thin", new List<string>{"mushrooms", "green peppers", "onions", "pepperoni", "black olives", "sausage"}, 20.00),
